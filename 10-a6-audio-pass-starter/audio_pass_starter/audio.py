...
class AudioBank:
    ...
    def _build_sounds(self) -> None:
        self._sounds = {
            ...
            "title_loop": self._make_tone(196.0, 700, 0.16, wave="sine"),
            "play_loop": self._make_tone(261.63, 520, 0.12, wave="triangle"),
            "collect_node": pygame.mixer.Sound("assets/node_collect.mp3"),
            "hazard_collide": pygame.mixer.Sound("assets/damage.mp3"),
            "victory_sound": pygame.mixer.Sound("assets/victory.mp3"),
            "gameover_sound": pygame.mixer.Sound("assets/gameover.mp3"),
            "game_music": pygame.mixer.Sound("assets/background_music.mp3"),

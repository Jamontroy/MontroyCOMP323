...
class Game:
    ...
    def __init__(self) -> None:
        ...
        self.sfx_coin = pygame.mixer.Sound("anim_feedback/assets/coinCollected.mp3") #Added
        self.sfx_damage = pygame.mixer.Sound("anim_feedback/assets/damage.mp3") #Added
    ...
    def draw(self) -> None:
        ...
        if self.warning_timer > 0: #Added
            text_surface = self.big_font.render("WATCH OUT!", True, (255, 50, 50))
...
def _make_coin_frames(color: pygame.Color) -> list[pygame.Surface]:
    ...
    scales = [1.0, 0.7, 0.4, 0.1, 0.4, 0.7, 1.0]
    ...
    for i in range(13):
        ...
        scale = scales[abs(i - 6)]

        width = int(r * 2 * scale)
        rect = pygame.Rect(0, 0, width, r * 2)
        rect.center = (cx, cy)

        pygame.draw.ellipse(surf, color, rect)
        pygame.draw.ellipse(surf, pygame.Color("#000000"), rect, 2)
